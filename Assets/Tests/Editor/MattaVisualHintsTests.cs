...
public class MattaVisualHintsTests
{
    ...
    public void Matta_Shows_Pair_Value_For_Decino_In_Hand()
    {
        ...
        System.Type.GetType("Project51.Unity.TurnController, Project51.Gameplay")?.GetMethod("StartNewGame")?.Invoke(tc, null);
        ...
        var vmType = System.Type.GetType("Project51.Unity.CardViewManager, Project51.Gameplay");
    ...
    public void Matta_Shows_Ace_For_Accuso_In_Hand()
    {
        ...
        System.Type.GetType("Project51.Unity.TurnController, Project51.Gameplay")?.GetMethod("SetupScenarioForCurrentPlayer")?.Invoke(tc, new object[] { hand, new List<Card>() });
    ...
    public void Matta_Plays_As_Seven_Not_Special()
    {
        ...
        tcType.GetMethod("ExecuteMove")?.Invoke(tc, new object[] { new Move(0, matta, MoveType.PlayOnly), false });
        Assert.Pass();
    }
}
